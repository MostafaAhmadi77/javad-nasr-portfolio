...
export default function SecoundItems({ title, des, icon: Icon }) {
  return (
    <div className=" w-full flex justify-between items-center w-1xl gap-4 bg-[#11121187] rounded-2xl p-2 ss:flex-col sm:flex-col sm:items-center sm:justify-center 
